...
const footerItems: { [key: string]: string[] }[] = [
  ...
  },
  {
    'Make Money with Us': [
      'Sell on ChainBridge',
      'Sell under ChainBridge Accelerator',
      'ChainBridge Global Selling',
      'Become an Affiliate',
      'Fulfilment by ChainBridge',
      'Advertise Your Products',
      'ChainBridge Pay on Merchants',
    ]
  },
  {
    'Let Us Help You': [
      'COVID-19 and ChainBridge',
      'Your Account',
      'Returns Centre',
      '100% Purchase Protection',
      'ChainBridge App Download',
      'ChainBridge Assistant Download',
      'Help',
    ]
  }
]
